# SLDNS
SSH OVER DNS create by Mrt
* Link Script Repo SlowDNS dari Sulaiman L
```html
https://github.com/mrctunnelplus/SLDNS
```

Script Auto Installer SlowDNS
```html
wget -q -O /usr/bin/install-sldns "https://raw.githubusercontent.com/mrctunnelplus/Mrt/main/SLDNS/install-sldns"
